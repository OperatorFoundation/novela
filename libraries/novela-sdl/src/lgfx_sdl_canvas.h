...
// An LGFXSDLCanvas implements the generic novela Canvas interface using the LovyanGFX library
// LGFXSDLCanvas inherits from novela-cpp's Canvas so that it can implement its virtual functions
